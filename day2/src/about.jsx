     ...
     <div><h1 className="AC">Fiberr!</h1>
      ...
      <div className="cntainer">
        <div className="about-content">
          ...
          <h2 style={{textAlign:'center'}}>Empowering Connections, Enriching Lives</h2>
        <p style={{fontSize:'20px',justifyContent:'space-between'}}>
          Welcome to Fiberr!, where innovation meets convenience in the realm of online recharges.
          At Fiberr!, we believe in the power of seamless connectivity and the transformative impact it can have on your daily life.Experience seamless and convenient mobile top-ups with our user-friendly platform.
